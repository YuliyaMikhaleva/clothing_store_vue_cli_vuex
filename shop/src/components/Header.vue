<template>
    <div class="header">
        <ul class="header_menu">
            <li class="header_menu_el"><a>Для мужчин</a></li>
            <li class="header_menu_el"><a>Для женщин</a></li>
            <li class="header_menu_el"><a>Для детей</a></li>
            <li class="header_menu_el">
                <router-link to="/"><img src="img/logo.png" alt="logo" /></router-link>
            </li>
            <li class="header_menu_el"><a>Оплата</a></li>
            <li class="header_menu_el"><a>Доставка</a></li>
            <li class="header_menu_el">
                <router-link to="/Cart" class="header_menu_el_basket" style="text-decoration: none; color: inherit;">
                    <svg
                            width="20"
                            height="26"
                            viewBox="0 0 30 28"
                    ...
                    >
                        <path
                                class="header_menu_el_basket_svg"
...
<script>
    export default {
        ...
        computed:{
            counter(){
                return this.$store.getters.getCart.reduce((acc,good) => acc + good.count, 0)
            }
        }
    }
</script>
